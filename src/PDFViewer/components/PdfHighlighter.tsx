...
import { HighlightLayer, MouseSelection, TipContainer } from "../components";
...
export default class PdfHighlighter<
  T_HT extends IHighlight
> extends PureComponent<Props<T_HT>, State<T_HT>> {
  static defaultProps = {
    pdfScaleValue: "auto",
  };
  ...
  onFind = (options: {
    ...
    if (this.viewer.eventBus) {
      this.viewer.eventBus.dispatch("find", options);
    }
  };
  ...
  onDocumentReady = () => {
    ...
    this.props.findRefs(this.goToPreviousMatch, this.goToNextMatch);
  };
